...
CREATE TABLE TB_TRANSACOES(
	...
	CHECK (VALOR > 0),
	CHECK (TIPO_TRANSACAO BETWEEN 1 AND 6), /*1- DEPOSITO, 2- SAQUE, 3- PIX, 4- BOLETO, 5- DEBITO, 6- TRANSFERENCIA*/
	FOREIGN KEY(ID_CONTA) REFERENCES TB_CONTAS(ID)
)
GO
...
CREATE TABLE TB_PIX(
	...
	CHAVE_DESTINO VARCHAR(50) NOT NULL,
	TIPO_PIX SMALLINT NOT NULL,
	CHECK(TIPO_PIX BETWEEN 1 AND 4),  /*1- cpf, 2- email, 3- telefone, 4- aleatória*/
	FOREIGN KEY(ID_TRANSACAO) REFERENCES TB_TRANSACOES(ID)
)
GO
...
CREATE TABLE TB_TRANSFERENCIAS (
    ...
    ID_TRANSACAO INT NOT NULL,  
    FOREIGN KEY (ID_CONTA_DESTINO) REFERENCES TB_CONTAS(ID), 
    FOREIGN KEY (ID_TRANSACAO) REFERENCES TB_TRANSACOES(ID)
)
GO
